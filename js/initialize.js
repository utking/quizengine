...
var init_question_data = [
    {
        ...
        questions: [
            ...
            {
                id: 2,
                text: "How many canscan a canner can if a canner can can cans?",
                correctAnswer: 2,
                answers: [
            ...
            },
            {
                ...
                correctAnswer: 2,
                answers: [
                    {text: "By the other pecks of pickled peppers that Petep Piper picked."},
            ...
            {
                id: 4,
                text: "This is not a question, or is it?",
                correctAnswer: 0,
                answers: [
    ...
    },
    {
        ...
        questions: [
            {
                id: 9,
                text: "Which of these lists contains all of the View classes of Marionette?",
                correctAnswer: 1,
                answers: [
            ...
            {
                id: 12,
                text: "What is chapter 1 of <i>Building Better Backbone Applications with MarionetteJS</i> about>",
                correctAnswer: 2,
                answers: [
                    {text: "Regions"},
                    {text: "Modules"},
